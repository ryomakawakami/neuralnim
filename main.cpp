...
int trainWinner(Computer* a, Computer* b);
...
int main() {
    ...
    // Display weights
    // for (int a = 0; a < 16; a++) {
    //     cout << *(trained.getWeights() + a) << endl;
    // }
    ...
    cout << float(win) / float(win + loss) * 100 << "%";
